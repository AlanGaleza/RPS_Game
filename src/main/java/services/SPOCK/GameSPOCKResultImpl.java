...
public class GameSPOCKResultImpl implements GameResultService {
    ...
    public boolean process(AiDrawService aiDrawService, PlayersCreator playersCreator, int rounds) {
        ...
        while(!end) {
            ...
            if (player1Counter != rounds && player2Counter != rounds) {
                ...
                System.out.println("Pick: 1 - Paper, 2 - Rock, 3 - Scissors, 4 - SPOCK, 5 - LIZARD, n - start again, x - end game");
                ...
                while(!pickLoop) {
                    ...
                    switch (player1Pick) {
                        ...
                        case "3" :
                            ...
                            break;
                        case "4" :
                            player1PickMove = Moves.SPOCK;
                            System.out.println("U picked: " + player1PickMove );
                            System.out.println("AI picked: " + player2Pick );
                            pickLoop = true;
                            break;
                        case "5" :
                            player1PickMove = Moves.LIZARD;
                            System.out.println("U picked: " + player1PickMove );
                            System.out.println("AI picked: " + player2Pick );
                            pickLoop = true;
                            break;
                ...
                if (player1Pick.equals("1") && player2Pick.equals(Moves.SCISSORS)) {
                ...
                } else if (player1Pick.equals("1") && player2Pick.equals(Moves.SPOCK)) {
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("1") && player2Pick.equals(Moves.LIZARD)) {
                    ++player2Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                    ...
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("2") && player2Pick.equals(Moves.SPOCK)) {
                    ++player2Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("2") && player2Pick.equals(Moves.LIZARD)) {
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                    ...
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("3") && player2Pick.equals(Moves.SPOCK)) {
                    ++player2Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("3") && player2Pick.equals(Moves.LIZARD)) {
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("4") && player2Pick.equals(Moves.ROCK)) {
                    ++player1Counter;
                    System.out.println(players.get(1).getUserName() + " win this round");
                } else if (player1Pick.equals("4") && player2Pick.equals(Moves.PAPER)) {
                    ++player2Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("4") && player2Pick.equals(Moves.SCISSORS)) {
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("4") && player2Pick.equals(Moves.LIZARD)) {
                    ++player2Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("5") && player2Pick.equals(Moves.ROCK)) {
                    ++player2Counter;
                    System.out.println(players.get(1).getUserName() + " win this round");
                } else if (player1Pick.equals("5") && player2Pick.equals(Moves.PAPER)) {
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("5") && player2Pick.equals(Moves.SPOCK)) {
                    ++player1Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
                } else if (player1Pick.equals("5") && player2Pick.equals(Moves.SCISSORS)) {
                    ++player2Counter;
                    System.out.println(players.get(0).getUserName() + " win this round");
